...
class SSD(object):
    ...
    def _built_net(self):
        ...
        self.end_points = {}  # record the detection layers output dict
    ...
    def _bboxes_decode_layer(self, feat_locations, anchor_bboxes, prior_scaling):
        ...
        params:
         ...
         prior_scaling: list of 4 floats 调节回归预测所起作用的比例
    ...
    def _bboxes_select_layer(self, feat_predictions, feat_locations, anchor_bboxes,
        ...
        scores = tf.boolean_mask(scores, filter_mask)  #mask is true keep
    ...
    def _bboxes_select(self, predictions, locations):
        ...
        for n in range(len(predictions)):
            ...
            # convert python-datatype to tense
        ...
        # combine all feat layers don't add dim
